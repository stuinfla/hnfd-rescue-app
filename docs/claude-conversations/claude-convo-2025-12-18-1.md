...
Just tried the app on an Android phone and no audio is coming up. Please troubleshoot and fix. 
...
Always remember to increment the versions whenever you're deploying new solutions: major.minor.bugfix. 
...
Provide an admin mode for someone to see all the data and update it as needed when they add new equipment or move where certain equipment is stored. 
...
Where's the admin functionality that lets people back up, view, and edit the equipment and its location? Give me a simplified version that someone could change in the app.

Also, some of the matched images aren't quite right. I know you only pulled about 300 frames from the video. Could you pull twice as many frames and try to get better images that align with the specific equipment and location being discussed? That might make the images more appropriate for each item. 
...
Where exactly did he mention the Lucas equipment? Can you timestamp it and tell me? 
...
so is it all fixed???  do yo have the app updated
...
Hey, change the process so whenever somebody speaks into it, the assumption is they absolutely want you to speak back the results of where it's located instantly. Don't make them press another button to turn the speaker on. Also, make sure you're using the better images. You mentioned, "I need to do this, but I don't want to do this." Please complete the fix and ensure it's working. On Android phones, the progressive web app isn't saving correctly—it's not showing up properly.

Can you confirm that the workflow is functioning as expected? 
