...
does it work 100% offline with speach in both directions?
...
<bash-notification>
<shell-id>a7b309</shell-id>
<status>completed</status>
<summary>Background command "Start server for testing" completed (exit code 0).</summary>
Use BashOutput with bash_id="a7b309" to retrieve the output.
</bash-notification>
